# trtamento de erros e exeções
# valor1=int(input("Digite o primeiro valor: "))
# valor2=int(input("Digite o segundo valor: "))
# resultado=valor1 / valor2
# print(f"O resultado da divisão é: {resultado}")
# o código acima pode gerar um erro de divisão por zero se o usuário digitar 0 para tratar esse erro, podemos usar um bloco try-except:
# try:
#    valor1=int(input("Digite o primeiro valor: "))
# valor2=int(input("Digite o segundo valor: "))
# resultado=valor1 / valor2
...
# Exemplo 3: Tratamento de múltiplas exeções
# try:
#     valor1=int(input("Digite o primeiro valor:"))
#     valor2=int(input("Digite o segundo valor: "))
#     resultado= valor1/valor2
...
#     print(f"Erro de valor: Por favor, digite um número inteiro válido. {e} ou Erro: Não é possivel dividir por zero. {e}")
